...
source_directory = '../output/mlcc/datasheet/images'
...
for index, row in df.iterrows():
    ...
    source_file_path = os.path.join(source_directory, part_number, part_number + "_0_1.png")
    ...
    # destination_directory = os.path.join(destination_base_directory, datasheet_filename, 'images')
    destination_directory = os.path.join(destination_base_directory, closest_directory, 'images')
